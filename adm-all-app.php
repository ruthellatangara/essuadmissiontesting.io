        ...
        <div class="content mt-3" >
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-12" id="autodata">
                        <div class="card">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="page-body float-right">
                                                ...
                                                if(isset($_SESSION['email'])){
                                                    echo '<button class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Export data to excel"><i class="fa fa-share"></i> <a href="adm-export-appli.php" class="text-light" style="text-decoration: none;">Export</a></button>

                                                    <button class="btn btn-secondary btn-sm" data-toggle="tooltip" data-placement="top" title="Add new applicant"><i class="fa fa-plus"></i> <a href="adm-addadm.php" class="text-light" style="text-decoration: none;">Add Applicant</a></button>
                                                    ';
                                                }
                                                ?>
                            ...
                            <?php
                                    ...
                                    ?>
                                        <div class="alert alert-success alert-dismissible fade show ml-5 mr-5" role="alert">
                                            <span class="badge badge-pill badge-success">Success</span> <?php echo $_SESSION['status']; ?>
                                ...
                                <table id="bootstrap-data-table-export" class="table table-hover">
                                    ...
                                    <?php 
                                        ...
                                        $sql="SELECT apprefno,
                                            ...
                                            CONCAT(brgy,', ', mun, ', ', prov) AS address,
                                            email,contact from account_tab where stat=1";
                                        ...
                                        if($result){
                                            while($row=mysqli_fetch_assoc($result)){
                                                ...
                                                <td class="text-center">
                                                    <a href="adm-getform.php? id='.$apprefno.'" class="btn btn-warning btn-sm text-light" data-toggle="tooltip" data-placement="top" title="See Student Admission Form"><i class="fa fa-eye"></i></a>
                                                    <a href="http://localhost/essu-admission-system/adm-pdf-appli.php? id='.$apprefno.'" target="_blank" name="pdf_application" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Print Student Admission Form"><i class="fa fa-print"></i></a>
                                                </td>
                                            </tr>';
                                            }
                                        }
