        ...
        <header id="header" class="header">
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-8">
                    ...
                    <h1>Summary of Permitted Applicants</h1>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="page-body float-right">
                                                ...
                                                if(isset($_SESSION['email'])){
                                                    echo '<button class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Export the list of all permitted applicants to excel"><i class="fa fa-share"></i> <a href="adm-export-permit.php" class="text-light" style="text-decoration: none;">Export</a></button>
                                                    ';
                                                }
                                                ?>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-hover">
                                    ...
                                    <?php 
                                        ...
                                        $sql="SELECT apprefno,CONCAT(lname,', ',fname,' ',mname) as fullname, tsite, date_format(tsched, '%M %e, %Y %r') as tsched from account_tab where stat1=1";
                                        ...
                                        if(!$result){
                                            die(mysqli_error($con));
                                             ...
                                             while($row=mysqli_fetch_assoc($result)){
                                                ...
                                                <td>'.$name.'</td>
                                                <td class="text-center">'.$t_sched.'</td>
                                                <td>'.$t_site.'</td>
                                                <td class="text-center">
                                                    <a href="http://localhost/essu-admission-system/adm-permit-pdf.php? id='.$apprefno.'" target="_blank" name="pdf-permit" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Print exam permit"><i class="fa fa-print"></i></a>
                                                </td>
                                            </tr>';
                                        }
                                        }
