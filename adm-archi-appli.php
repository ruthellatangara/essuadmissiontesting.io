        ...
        <header id="header" class="header">
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-7">
                    ...
                    <h1>Archived Application List</h1>
                                        ...
                                        <div class="page-body float-right">
                                            ...
                                            if (isset($_SESSION['email'])) {
                                                if (isset($_POST['yes'])) {
                                                    ...
                                                    $export = mysqli_query($con, "SELECT sy from `student_archive` where sy='$application'");

                                                    if ($export) {
                                                        echo '
                                                        <a href="adm-export-archi-appli.php? export='.$application.'"" class="text-light btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Export data to excel" style="text-decoration: none;"><i class="fa fa-share"></i> Export</a>
                                                        ';
                                                    }
                                    ...
                                    <?php 
                                        if (isset($_SESSION['email'])) {
                                            if (isset($_POST['yes'])) {
                                                ...
                                                $sql="SELECT apprefno,
                                                    ...
                                                    email,sy from `student_archive` where sy='$application'";
                                                    ...
                                                    if($result){
                                                        while($row=mysqli_fetch_assoc($result)){
                                                            ...
                                                            <td class="text-center">
                                                                <a href="adm-getform-archive.php? id='.$apprefno.'" class="btn btn-warning btn-sm text-light" data-toggle="tooltip" data-placement="top" title="See Admission Form"><i class="fa fa-eye"></i></a>
                                                                <a href="http://localhost/essu-admission-system/adm-pdfappli-archive.php? id='.$apprefno.'" target="_blank" name="pdf_application" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Print Admission Form"><i class="fa fa-print"></i></a>
                                                            </td>
                                                        </tr>';
                                                        }
                                                    }
                                        ...
                                        if (isset($_SESSION['email'])) {
                                            if (isset($_GET['application'])) {
                                                ...
                                                $sql="SELECT apprefno,
                                                    CONCAT (fname, ' ', mname, ' ', lname) AS name, tsite,
                                                    email,sy from `student_archive` where sy='".$_GET['application']."'";
                                                    $result=mysqli_query($con,$sql);
