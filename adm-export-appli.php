...
$sql = "SELECT apprefno, CONCAT (lname,', ',fname,' ',mname) as name, email,contact,date_format(dob, '%M %e %Y') as dob,pob,sex,civstat,brgy,mun,prov,lschool,lsaddress,lsy,genave,
       CONCAT (q1,'. ',q1a) as q1,CONCAT (q2,'. ',q2a) as q2,tsite,sy,campus,tsched,fchoice,schoice,tchoice FROM account_tab where apprefno != '' and stat=1";
