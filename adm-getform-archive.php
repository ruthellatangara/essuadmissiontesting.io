...
if (isset($_SESSION['email'])) {
    $apprefno=$_GET['id'];
    $sql="SELECT apprefno,sy,campus,tsite,fchoice,schoice,tchoice,lname,fname,mname,email,contact,dob,pob,sex,civstat,brgy,mun,prov,lschool,lsaddress,lsy,genave,q1,q1a,q2,q2a from student_archive where apprefno='$apprefno'";
    ...
    <div class="container mt-3 mb-4">
        ...
        <form class="row g-3" action="file-upload.php" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="t_site" name="t_site" value="'.$t_site.'" readonly>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-1">
                <a href="adm-archi-appli.php? application='.$schoolyear.'" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> Back</a>
            </div>
            <div class="col-md-3">
                <a href="adm-fileup-archive.php? id='.$apprefno.'" class=" btn btn-primary btn-sm"><i class="fa fa-folder-open-o"></i> See required files uploaded</a>
            </div>
        </form>
    </div>
</body>
