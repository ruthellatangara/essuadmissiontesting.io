...
if(isset($_GET['id'])){
    ...
    $sql="SELECT apprefno,sy,campus,fchoice,schoice,tchoice,lname,fname,mname,email,contact,date_format(dob, '%M %e, %Y') as dob,
    pob,sex,civstat,brgy,mun,prov,lschool,lsaddress,lsy,genave,q1,q1a,q2,q2a FROM account_tab where apprefno='$apprefno'";
...
$pdf->Multicell(61,10,''.$fchoice, 1, 'L', 1, 0, '', '', true);
$pdf->Multicell(61,10,''.$schoice, 1, 'L', 1, 0, '', '', true);
$pdf->Multicell(61,10,''.$tchoice, 1, 'L', 1, 1, '', '', true);
...
$pdf->Multicell(50,12,''.$school, 1, 'L', 1, 0, '', '', true);
$pdf->Multicell(65,12,''.$address, 1, 'L', 1, 0, '', '', true);
...
$pdf->setFont('helvetica','',10);
$pdf->Cell(92,9,'',1,0,'C',1);
$pdf->cell(91,9,'',1,1,'C',1);
$pdf->setFillColor(224,235,255);
