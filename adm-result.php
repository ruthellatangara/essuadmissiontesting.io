            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" href="stu-logout.php">Yes</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Permitted Applicants</strong>
                                <?php
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-hover">
                                    ...
                                    <?php 
                                        ...
                                        $sql="SELECT apprefno,CONCAT(lname,', ',fname,' ',mname) as fullname, tsite,date_format(tsched, '%M %e, %Y %r') as tsched from account_tab where stat2=1";
                                            ...
                                            die(mysqli_error($con));
                                             ...
                                             while($row=mysqli_fetch_assoc($result)){
                                                ...
                                                <td class="text-center">
                                                     <a href="adm-score-form.php? scoreid='.$apprefno.'" class="btn btn-primary btn-sm text-light" data-toggle="tooltip" data-placement="top" title="Input exam result"><i class="fa fa-pencil-square-o"></i></a>
                                                </td>
                                            </tr>';
                                        }
                                        }
