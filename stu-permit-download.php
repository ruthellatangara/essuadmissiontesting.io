...
if (isset($_SESSION['email'])) {
        ...
        $query="SELECT apprefno, CONCAT (fname, ' ', mname, ' ', lname) AS name, tsched, tsite, date_format(relresult, '%M %e, %Y') as relresult,sy from account_tab where apprefno='$apprefno'";
        ...
        */
        ...
        $pdf->Output('essu-admission-permit.pdf','D');
